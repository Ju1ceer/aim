...
def draw_mainmenu():
    from pythonProject1.defs.utils_go_back import Button, buttonstyle, screen_width, screen_height, screen
    from pythonProject1.quick_shot import draw_quick_shot
    from pythonProject1.six_shots import draw_six_shots
