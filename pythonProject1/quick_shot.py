def draw_quick_shot(screen):
    ...
    from pythonProject1.defs.leaderboard import get_quickshot_leaderboard, show_leaderboard
    from pythonProject1.defs.sql import get_player_name, insert_score_quickshot
